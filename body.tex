...
\begin{figure}
    ...
    \caption{Left: The ratio of fluxes between \emph{Gaia} XPsynthetic photometry and SDSS for the \textit{u}-band as a function of \textit{g-r} color. The red line shows the cubic spline that defines our color transformation.
    Right: Residuals between \emph{Gaia} XPsynthetic photometry transformed to SDSS and SDSS as a function of magnitude.}
