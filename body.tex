...
This fit is done by taking an arbitrary high lattitude spatial region where the source and target refcats overlap \FIXME{quote the region for training}. 
Over this region we 1) read in the source refcat, target refcat, and \emph{Gaia}-DR3, 2) we spatially match the source and target refcats to \emph{Gaia}-DR3, with a 0.5'' matching radius. 3) in the source catalog we apply a single band, \textit{i}-band by default, selection to obtain a sample of high-quality stellar-sources.  
...
\begin{figure}
    ...
    Right: Histogram of $u_{\mathrm{slr}}$ - $u_{sdss}$ for the high galactic latitude ($|b| > 30$) regions of the map \FIXME{axis label wrong}. }
\end{figure}
...
To improve the internal consistency of our reference catalog we apply this offset, at \texttt{NSIDE}=32, to the $u_{\mathrm{slr}}$ measurements.
...
\begin{table}[htbp]
    ...
    \begin{tabular}{|c | c | c | c | c | c |}
        ...
        band & internal & color range & $N_{src}$  & magnitude range & \% bad pix\\
             & bandpass &             & per pix256 &                 &$\delta < 30$\\
        \hline
        u             &  SDSS                      & g-r=0.35--0.7        & 69                      & 7.62--23.82   &  2.5  \\
        g             & DES                        & g-i=0.35--3.0        & 221                     & 6.78--23.31   &  0.01 \\
        r             & DES                        & g-i=0.35--3.0        & 218                     & 6.49--22.03   &  0.01 \\
        i             & DES                        & g-i=0.35--3.0        & 221                     & 6.41--21.38   &  0.01 \\
        z             & DES                        & i-z=0.0--0.7         & 251                     & 6.40--21.34   &  0.01 \\
        y             & DES                        & i-z=1.5--30          & 133                     & 6.43--20.83   &  0.02 \\
        \hline
    \end{tabular}
